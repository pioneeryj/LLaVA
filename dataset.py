...
class Dataset(data.Dataset):
    def __init__(self, root, transform, target_transform, dataset_name, mode='test'):
        ...
        self.data_all = []
        meta_info = json.load(open(f'/mnt/HDD/yoonji/anomalyCBM/data/{dataset_name}/meta.json', 'r'))
    ...
    def __getitem__(self, index):
        ...
        img = Image.open(os.path.join(self.root, img_path)).convert('RGB')  # Ensure RGB format
        if anomaly == 0:
